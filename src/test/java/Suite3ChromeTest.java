...
public class Suite3ChromeTest {
  ...
  private void clickNavByIndex(int index){ WebElement link=driver.findElement(By.xpath("(//header//*[contains(@class,'nav')]//a[@href='#'])["+index+"]")); js.executeScript("arguments[0].click();", link); sleep(700); }
  private void clickSocialByIndex(int index){ WebElement icon=driver.findElement(By.xpath("(//*[contains(@class,'social-icon')])["+index+"]")); js.executeScript("arguments[0].click();", icon); }
